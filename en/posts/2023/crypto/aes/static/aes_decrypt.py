...
import binascii
from aes_encrypt import tostate, addroundkey
...
if __name__ == "__main__":
    ...
    ciphertext = "c69f25d0025a9ef32393f63e2f05b747"
    ciphertext_bytes = binascii.unhexlify(ciphertext)
    plain = decrypt(ciphertext_bytes, key_bytes, 10)
    np.set_printoptions(formatter={'int':lambda x:chr(int(x))})
    '''
    expected : plain = "theblockbreakers"
    '''
    print(plain)